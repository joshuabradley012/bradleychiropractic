          ...
          <div className="row justify-content-center">
            ...
            <div className="col-8">
              <div className={styles.map}>
                <div className={cn('content', styles.mapLeft)}>
          ...
          <div className="row">
            {testimonials.map((testimonial, i) => (
              <div className="col-4" key={i}>
                <div className={styles.testimonial}>{testimonial.quote}</div>
              </div>
            ))}
          </div>
        </div>
